 ...
 * blocks of the TGraph data representation model. Nodes are created by invoking
 ...
 * {@link Entity}.
 * <p>
 * A Neo4j node's id is unique, but note the following: Neo4j reuses its internal ids
 ...
 * <p>
 * TGraph Node wrappers Neo4j Node but adds more information, thus inherits the above properties of Neo4j Node.
 */
public interface Node extends Entity {
    ...
    /**
     * Returns all the relationships of the types in <code>types</code>
    ...
    /**
     * Returns <code>true</code> if there are any relationships of the
     * types in <code>types</code> attached to this node (regardless of
     * direction), <code>false</code> otherwise.
     *
     * @param types the given relationship type(s)
     * @return <code>true</code> if there are any relationships of the
     ...
     * need to create another relationship in the opposite direction (in regard
